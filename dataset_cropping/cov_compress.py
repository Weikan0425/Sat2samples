...
def process_and_compress_tiff(input_directory, output_directory, compression="LZW"):
    # 获取输入目录中的所有TIFF文件
    ...
    for tiff_file in tqdm(tiff_files, desc="Processing and compressing TIFF files"):
    ...
    print("All TIFF files processed and compressed.")
